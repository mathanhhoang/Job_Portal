		...
		<div class="row">
			<div class="col-md-12">
				...
				<c:if test="${not empty succMsg}">
					...
					<div>
					<form class="form-inline" action="search_user.jsp" method="get" style="margin-bottom: 10px">
						<div>
							<input class="form-control mr-sm-2" type="search" name="search" placeholder="Search Name">
							<button class="btn btn-success"><i class="fas fa-search"></i>Tìm kiếm</button>
							<a href="view_user.jsp"><button class="btn btn-primary"><i class="fas fa-users"></i> Xem tất cả </button></a>
						</div>
					</form>
					</div>
					...
					<div class="content" style="text-aglin: center; background-color: white;">
						<div class="tablemain" style="text-aglin: center; width: 100%;">
							...
							<table class="table">
								...
								List<User> list = dao.getAllUserForName(name);
								if(list == null){
									msg = "Chưa có người dùng này trong danh sách!";
								}else{
									for (User j : list) {
								%>
								<tr	style ="width: 100%;">
